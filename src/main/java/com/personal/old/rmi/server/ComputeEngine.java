package com.personal.old.rmi.server;
...
import com.personal.old.rmi.server.interfaces.Compute;
import com.personal.old.rmi.server.interfaces.Task;
 ...
 *  
 * $ java -Djava.rmi.server.hostname=127.0.0.1 -Djava.security.policy=server.policy com.personal.old.rmi.server.ComputeEngine
 * 
 */
